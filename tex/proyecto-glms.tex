...
\rfoot{Modelos lineales generalizados para seguros}
...
\fancypagestyle{firstpage}{
  ...
  \chead{
      \begin{tabular}{|ccc|r|}
           \hline
           \multirow{14}{*}{\includegraphics[scale=0.13]{../images/Escudo_de_la_Universidad_Nacional_de_Colombia_(2016).png}} &  &  &  \\
           ...
           & {\large para seguros} &  & \textbf{Profesor:} \\
           &  &  & Luz Mery Gonzalez G. \\
           & {\Large Pricing de seguros utilizando}  &  & lgonzalezg@unal.edu.co \\
           & {\Large modelos lineales generalizados} &  &  \\
           &  &  &  \href{github.com/riemannintegrable/proyecto-glms}{\textbf{Repositorio}}\\
           &  &  &  \\
